...
public class IndexController {
	...
	public String loginApi(@RequestBody LoginForm form) {
		List<User> users = userRepos.findByUserNameAndPassword(form.getUserName(), form.getPassword()); //importするもの間違えないように！色々ある！
	...
	public String historyApi (@RequestBody HistoryForm form) {//購入履歴を表示させる
